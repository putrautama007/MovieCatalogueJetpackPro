...
import com.b.moviecataloguemvvm.model.DataSource
import com.b.moviecataloguemvvm.model.NetworkBoundResource
...
open class FakeDataRepository (
    ...
    companion object {
        ...
        fun getInstance(local: LocalRepository, remote: com.b.moviecataloguemvvm.model.remote.RemoteRepositoryJava, appExecutors: AppExecutors): FakeDataRepository? {
            if (INSTANCE == null) {
                synchronized(DataRepository::class.java) {
                    if (INSTANCE == null) {
                        INSTANCE = FakeDataRepository(local, remote,appExecutors)
                    }
                }
            }
            return INSTANCE
